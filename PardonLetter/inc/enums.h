enum ePedScriptConfigFlags
{
	...
	PCF_IsAimingGun,
	PCF_0x0BFD1CB9,
	PCF_0x8C114A94, // is pulling out/putting away weapon?
	PCF_0xCC752CBF,
	PCF_0xCED7C547,
	PCF_0xAFB27B1E,
	PCF_0xDD234FD4,
...
enum eState : Hash
{
	STATE_LEMOYNE = 2488505823,
	STATE_WEST_ELIZABETH = 3600505673,
	STATE_NEW_HANOVER = 1093870742,
	STATE_AMBARINO = 999150106,
	STATE_NEW_AUSTIN = 1098225713,
	STATE_GUARMA = 2466774337,
};


enum class eStateFlag : int
{
	STATE_FLAG_NONE,
	STATE_FLAG_IS_IN_LOCKDOWN,
	STATE_FLAG_IS_IN_LOCKDOWN_IN_FLOW,
	STATE_FLAG_IS_WANTED_ZONE = 4,
};


enum class eDistrictFlag : int
{
	DISTRICT_FLAG_NONE,
	DISTRICT_FLAG_IS_IN_LOCKDOWN,
	DISTRICT_FLAG_IS_IN_LOCKDOWN_IN_FLOW,
	DISTRICT_FLAG_IS_WANTED_ZONE = 4,
	DISTRICT_FLAG_SUPPRESS_PASSIVE = 8,
};


enum class eRegionFlag : Hash
{
	RF_LOCKDOWN = 33554432,
	RF_PERMANENT_LOCKDOWN = 16777216,
	RF_WANTED_ZONE = 67108864,
};


enum eLBS : int
{
	LAW_BOUNTY_STATE_INVALID = -1,
	LAW_BOUNTY_STATE_FIRST, // AMBARINO
	LAW_BOUNTY_STATE_NEW_HANOVER,
	LAW_BOUNTY_STATE_LEMOYNE,
	LAW_BOUNTY_STATE_WEST_ELIZABETH,
	LAW_BOUNTY_STATE_NEW_AUSTIN,
	LAW_BOUNTY_STATE_GUARMA,
	LAW_BOUNTY_STATE_MAX,
};


enum class eRegionIndex : int
{
	REGION_INVALID = -1,
	REGION_FIRST, // REGION_BAY_CRAWDADWILLIES
	REGION_BAY_MACOMBS_END,
	REGION_BAY_MERKINSWALLER,
	REGION_BAY_LAGRAS,
	REGION_BAY_LAKAY,
	REGION_BAY_SAINT_DENIS,
	REGION_BAY_ORANGE_PLANTATION,
	REGION_BAY_SERIAL_KILLER,
	REGION_BAY_SERENDIPITY,
	REGION_BAY_SHADYBELLE,
	REGION_BAY_SILTWATERSTRAND,
	REGION_BGV_APPLESEEDTIMBER,
	REGION_BGV_BERYLS_DREAM,
	REGION_BGV_BLACKBONEFOREST_TRAPPER,
	REGION_BGV_DAKOTARIVER_TRAPPER,
	REGION_BGV_FORTRIGGS,
	REGION_BGV_HANGINGDOG,
	REGION_BGV_LONEMULESTEAD,
	REGION_BGV_MISSING_HUSBAND,
	REGION_BGV_MONTO_REST,
	REGION_BGV_OWANJILA_DAM,
	REGION_BGV_PAINTEDSKY,
	REGION_BGV_PRONGHORN,
	REGION_BGV_RIGGS_STATION,
	REGION_BGV_SHACK,
	REGION_BGV_SHEPHERDS_RISE,
	REGION_BGV_STRAWBERRY,
	REGION_BGV_VALLEY_VIEW,
	REGION_BGV_WALLACE_STATION,
	REGION_BGV_OLD_MAN_JONES,
	REGION_BGV_LAST,
	REGION_BLU_FIRST,
	REGION_BLU_COPPERHEAD,
	REGION_BLU_SISIKA,
	REGION_BLU_LAST,
	REGION_CML_BACCHUSBRIDGE,
	REGION_CML_DINO_LADY,
	REGION_CML_OLDFORTWALLACE,
	REGION_CML_LAST,
	REGION_GRT_BEECHERS,
	REGION_GRT_BLACKWATER,
	REGION_GRT_QUAKERS_COVE,
	REGION_GRW_FIRST,
	REGION_GRZ_DEAD_RIVAL,
	REGION_GRZ_CHEZPORTER,
	REGION_GRZ_COLTER,
	REGION_GRZ_FROZEN_EXPLORER,
	REGION_GRZ_MILLESANI_CLAIM,
	REGION_GRZ_MOUNTAIN_MAN,
	REGION_GRZ_MOUNT_HAGEN_PEAK,
	REGION_GRZ_STARVING_CHILDREN,
	REGION_GRZ_TEMPEST_RIM,
	REGION_GRW_LAST,
	REGION_GRZ_CALUMETRAVINE,
	REGION_GRE_CIVIL_WAR_BRIDE,
	REGION_GRZ_COHUTTA,
	REGION_GRZ_COTORRA_SPRINGS,
	REGION_GRZ_GUNFIGHT,
	REGION_GRZ_THELOFT,
	REGION_GRE_VETERAN,
	REGION_GRZ_WAPITI,
	REGION_GRZ_TRAVELLING_SALESMAN,
	REGION_GUA_FIRST,
	REGION_GUA_CAMP,
	REGION_GUA_CINCOTORRES,
	REGION_GUA_LACAPILLA,
	REGION_GUA_LAST,
	REGION_HRT_ABANDONED_MILL,
	REGION_ROA_BEECHERS_C,
	REGION_HRT_CARMODYDELL,
	REGION_HRT_CORNWALLKEROSENE,
	REGION_HRT_CROP_FARM,
	REGION_HRT_CUMBERLANDFALLS,
	REGION_HRT_DOWNSRANCH,
	REGION_HRT_EMERALDRANCH,
	REGION_HRT_GRANGERS_HOGGERY,
	REGION_HRT_HORSESHOEOVERLOOK,
	REGION_HRT_LARNEDSOD,
	REGION_HRT_LOONY_CULT,
	REGION_HRT_LUCKYSCABIN,
	REGION_HRT_SWANSONS_STATION,
	REGION_HRT_VALENTINE,
	REGION_ROA_FIRST,
	REGION_ROA_ANNESBURG,
	REGION_ROA_BEAVERHOLLOW,
	REGION_ROA_BLACK_BALSAM_RISE,
	REGION_ROA_BRANDYWINE_DROP,
	REGION_ROA_BUTCHERCREEK,
	REGION_ROA_DOVERHILL,
	REGION_ROA_HAPPY_FAMILY,
	REGION_ROA_ISOLATIONIST,
	REGION_ROA_MACLEANSHOUSE,
	REGION_ROA_MOSSY_FLATS,
	REGION_ROA_ROANOKE_VALLEY,
	REGION_ROA_ROCKYSEVEN,
	REGION_ROA_TRAPPER,
	REGION_ROA_OLD_MAN_JONES,
	REGION_ROA_VANHORNMANSION,
	REGION_ROA_LAST,
	REGION_SCM_FIRST,
	REGION_SCM_BULGERGLADE,
	REGION_SCM_CALIGAHALL,
	REGION_SCM_CATFISHJACKSONS,
	REGION_SCM_CLEMENSCOVE,
	REGION_SCM_CLEMENSPOINT,
	REGION_SCM_COMPSONS_STEAD,
	REGION_SCM_DAIRY_FARM,
	REGION_SCM_HORSE_SHOP,
	REGION_SCM_LONNIESSHACK,
	REGION_SCM_LOVE_TRIANGLE,
	REGION_SCM_RADLEYS_PASTURE,
	REGION_SCM_RHODES,
	REGION_SCM_LAST,
	REGION_TAL_FIRST,
	REGION_TAL_DEAD_SETTLER,
	REGION_TAL_COCHINAY,
	REGION_TAL_MANZANITAPOST,
	REGION_TAL_PACIFICUNIONRR,
	REGION_TAL_TANNERSREACH,
	REGION_TAL_TRAPPER,
	REGION_GAP_FIRST,
	REGION_GAP_TUMBLEWEED,
	REGION_GAP_LAST,
	REGION_RIO_BENEDICT_POINT,
	REGION_RIO_FORT_MERCER,
	REGION_RIO_PLAIN_VIEW,
	REGION_RIO_LAST,
	REGION_CHO_FIRST,
	REGION_CHO_COOTS_CHAPEL,
	REGION_CHO_DON_JULIO_HOUSE,
	REGION_CHO_RILEYS_CHARGE,
	REGION_CHO_RIDGEWOOD_FARM,
	REGION_CHO_TWIN_ROCKS,
	REGION_CHO_TRAVELLING_SALESMAN,
	REGION_CHO_LAST,
	REGION_HEN_FIRST,
	REGION_HEN_THIEVES_LANDING,
	REGION_HEN_TRAVELLING_SALESMAN,
	REGION_HEN_HARRIET,
	REGION_CENTRALUNIONRR,
	REGION_LAST,
	REGION_MAX = 150,
};


enum class eRegionHash : Hash
{
	REGION_UNK1 = 2209803665, // TODO
	REGION_BAY_CRAWDADWILLIES = 4290353529,
	REGION_BAY_MACOMBS_END = 1567162363,
	REGION_BAY_MERKINSWALLER = 456471693,
	REGION_BAY_LAGRAS = 2522003822,
	REGION_BAY_LAKAY = 1881496386,
	REGION_BAY_SAINT_DENIS = 711768994,
	REGION_BAY_ORANGE_PLANTATION = 3854133230,
	REGION_BAY_SERIAL_KILLER = 2931119464,
	REGION_BAY_SERENDIPITY = 967769300,
	REGION_BAY_SHADYBELLE = 2858093352,
	REGION_BAY_SILTWATERSTRAND = 2709298157,
	REGION_BGV_APPLESEEDTIMBER = 16791368,
	REGION_BGV_BERYLS_DREAM = 1452922822,
	REGION_BGV_BLACKBONEFOREST_TRAPPER = 549538301,
	REGION_BGV_DAKOTARIVER_TRAPPER = 974698954,
	REGION_BGV_FORTRIGGS = 445881012,
	REGION_BGV_HANGINGDOG = 2251075439,
	REGION_BGV_LONEMULESTEAD = 419656993,
	REGION_BGV_MISSING_HUSBAND = 2562509981,
	REGION_BGV_MONTO_REST = 1794318026,
	REGION_BGV_OWANJILA_DAM = 2035159966,
	REGION_BGV_PAINTEDSKY = 770832805,
	REGION_BGV_PRONGHORN = 3185152530,
	REGION_BGV_RIGGS_STATION = 3214649561,
	REGION_BGV_SHACK = 3219416933,
	REGION_BGV_SHEPHERDS_RISE = 2138576151,
	REGION_BGV_STRAWBERRY = 1180954297,
	REGION_BGV_VALLEY_VIEW = 783603394,
	REGION_BGV_WATSONSCABIN = 4124508960,
	REGION_BGV_OLD_MAN_JONES = 2023240596,
	REGION_BLU_CANEBREAK_MANOR = 1285083821,
	REGION_BLU_COPPERHEAD = 2454059834,
	REGION_BLU_SISIKA = 756710130,
	REGION_BLU_TRAVELLING_SALESMAN = 1634157321,
	REGION_CML_BACCHUSBRIDGE = 388370024,
	REGION_CML_DINO_LADY = 1092296123,
	REGION_CML_OLDFORTWALLACE = 467491346,
	REGION_CML_SIXPOINTCABIN = 2903382684,
	REGION_GRT_BEECHERS = 4142855950,
	REGION_GRT_BLACKWATER = 1447551317,
	REGION_GRT_QUAKERS_COVE = 153136092,
	REGION_GRZ_ADLERRANCH = 1304405732,
	REGION_GRZ_DEAD_RIVAL = 1074984055,
	REGION_GRZ_CALUMETRAVINE = 1087476368,
	REGION_GRE_CIVIL_WAR_BRIDE = 2526909956,
	REGION_GRZ_CHEZPORTER = 1218874593,
	REGION_GRZ_COHUTTA = 2856523460,
	REGION_GRZ_COLTER = 2258626881,
	REGION_GRZ_COTORRA_SPRINGS = 3697689146,
	REGION_GRZ_FROZEN_EXPLORER = 803939643,
	REGION_GRZ_GUNFIGHT = 3662471101,
	REGION_GRZ_MILLESANI_CLAIM = 3329023677,
	REGION_GRZ_MOUNTAIN_MAN = 283532073,
	REGION_GRZ_MOUNT_HAGEN_PEAK = 3832139772,
	REGION_GRZ_STARVING_CHILDREN = 4225899805,
	REGION_GRZ_TEMPEST_RIM = 2430072178,
	REGION_GRZ_THELOFT = 2365160725,
	REGION_BGV_WALLACE_STATION = 1162337247,
	REGION_GRE_VETERAN = 3596441879,
	REGION_GRZ_WAPITI = 3145227402,
	REGION_GRZ_WINTERMINING_TOWN = 380507325,
	REGION_GRZ_TRAVELLING_SALESMAN = 3419825221,
	REGION_GUA_AGUASDULCES = 407796241,
	REGION_GUA_CAMP = 4142699382,
	REGION_GUA_CINCOTORRES = 2619523976,
	REGION_GUA_LACAPILLA = 1940341639,
	REGION_GUA_MANICATO = 1846596114,
	REGION_HRT_ABANDONED_MILL = 907708501,
	REGION_HRT_CARMODYDELL = 1825644981,
	REGION_HRT_CORNWALLKEROSENE = 2065937607,
	REGION_HRT_CROP_FARM = 4083649879,
	REGION_HRT_CUMBERLANDFALLS = 1801307910,
	REGION_HRT_DOWNSRANCH = 4290848399,
	REGION_HRT_EMERALDRANCH = 1853610692,
	REGION_HRT_GRANGERS_HOGGERY = 2720322881,
	REGION_HRT_HORSESHOEOVERLOOK = 2133055515,
	REGION_HRT_LARNEDSOD = 2881565364,
	REGION_HRT_LOONY_CULT = 801090761,
	REGION_HRT_LUCKYSCABIN = 2131218644,
	REGION_HRT_SWANSONS_STATION = 1708823660,
	REGION_HRT_VALENTINE = 7976942,
	REGION_ROA_ABERDEENPIGFARM = 2111120505,
	REGION_ROA_ANNESBURG = 176893118,
	REGION_ROA_BEECHERS_C = 602306665,
	REGION_ROA_BEAVERHOLLOW = 1179148161,
	REGION_ROA_BLACK_BALSAM_RISE = 547412068,
	REGION_ROA_BRANDYWINE_DROP = 2755218495,
	REGION_ROA_BUTCHERCREEK = 2689847384,
	REGION_ROA_DOVERHILL = 3410503233,
	REGION_ROA_HAPPY_FAMILY = 2873996576,
	REGION_ROA_ISOLATIONIST = 1017024547,
	REGION_ROA_MACLEANSHOUSE = 3090469990,
	REGION_ROA_MOSSY_FLATS = 2673897816,
	REGION_ROA_ROANOKE_VALLEY = 3836363035,
	REGION_ROA_ROCKYSEVEN = 3371575682,
	REGION_ROA_TRAPPER = 3605720207,
	REGION_ROA_VANHORNMANSION = 44049568,
	REGION_ROA_VANHORNPOST = 1350259552,
	REGION_ROA_OLD_MAN_JONES = 620414938,
	REGION_SCM_BRAITHWAITEMANOR = 4233305722,
	REGION_SCM_BULGERGLADE = 3569629242,
	REGION_SCM_CALIGAHALL = 3524843789,
	REGION_SCM_CATFISHJACKSONS = 1322486734,
	REGION_SCM_CLEMENSCOVE = 3834027743,
	REGION_SCM_CLEMENSPOINT = 2843103744,
	REGION_SCM_HORSE_SHOP = 713715980,
	REGION_SCM_LONNIESSHACK = 4263762327,
	REGION_SCM_LOVE_TRIANGLE = 2574902506,
	REGION_SCM_COMPSONS_STEAD = 173833068,
	REGION_SCM_DAIRY_FARM = 2613963160,
	REGION_SCM_RADLEYS_PASTURE = 3762794521,
	REGION_SCM_RHODES = 3555899559,
	REGION_SCM_SLAVE_PEN = 3091833461,
	REGION_TAL_AURORA_BASIN = 2347555698,
	REGION_TAL_DEAD_SETTLER = 3245213931,
	REGION_TAL_COCHINAY = 2996248534,
	REGION_TAL_MANZANITAPOST = 3699884232,
	REGION_TAL_PACIFICUNIONRR = 884833917,
	REGION_TAL_TANNERSREACH = 2141950651,
	REGION_TAL_TRAPPER = 2857316567,
	REGION_HEN_MACFARLANES_RANCH = 672925454,
	REGION_HEN_THIEVES_LANDING = 846062774,
	REGION_HEN_TRAVELLING_SALESMAN = 1713550306,
	REGION_UNK2 = 2721404512, // TODO
	REGION_CHO_ARMADILLO = 1369756178,
	REGION_CHO_COOTS_CHAPEL = 3558794873,
	REGION_CHO_DON_JULIO_HOUSE = 1597070291,
	REGION_CHO_RIDGEWOOD_FARM = 4135465732,
	REGION_CHO_RILEYS_CHARGE = 2856157688,
	REGION_CHO_TWIN_ROCKS = 4192284904,
	REGION_CHO_TRAVELLING_SALESMAN = 676673543,
	REGION_UNK3 = 1869665995, // TODO
	REGION_GAP_GAPTOOTH_BREACH = 4213898317,
	REGION_GAP_TUMBLEWEED = 227618407,
	REGION_GAP_RATHSKELLER_FORK = 2106043438,
	REGION_RIO_BENEDICT_POINT = 2914711232,
	REGION_RIO_FORT_MERCER = 2176498113,
	REGION_RIO_PLAIN_VIEW = 3735969462,
	REGION_RIO_TRAVELLING_SALESMAN = 1563120499,
	REGION_CENTRALUNIONRR = 658339366,
...
{
	SHOP_FLAG_NONE = 0,
	SHOP_FLAG_DISABLED = (1 << 0),
	SHOP_FLAG_OUTSIDE = (1 << 1),
	SHOP_FLAG_BLIP_DISABLED = (1 << 2),
	SHOP_FLAG_BLIP_OBJECTIVE = (1 << 3),
	SHOP_FLAG_BLIP_STATE_LOCKED = (1 << 4),
	SHOP_FLAG_BLIP_STATE_HIDDEN = (1 << 5),
	SHOP_FLAG_BLIP_STATE_TOD = (1 << 6),
	SHOP_FLAG_BLIP_STATE_OBJECTIVE = (1 << 7),
	SHOP_FLAG_ALLWAYSOPEN = (1 << 8),
	SHOP_FLAG_ALLWAYSCLOSED = (1 << 9),
	SHOP_FLAG_BEING_ROBBED = (1 << 10),
	SHOP_FLAG_MUTE_DIALOGUE_THIS_FRAME = (1 << 11),
	SHOP_FLAG_STAYAT_COUNTER = (1 << 12),
	SHOP_FLAG_SHOP_KEEPER_DESPAWN = (1 << 13),
	SHOP_FLAG_CLOSED = (1 << 14),
	SHOP_FLAG_CLOSED_TOD = (1 << 15),
	SHOP_FLAG_KEEPER_TURNEDOFF = (1 << 16),
	SHOP_FLAG_COUNTER_ENABLED = (1 << 17),
	SHOP_FLAG_NEXT_ITEM_IS_FREE = (1 << 18),
	SHOP_FLAG_SHOPKEEPER_ALWAYS_ALIVE = (1 << 19),
	SHOP_FLAG_FORCE_LOCK = (1 << 20),
	SHOP_FLAG_DOORS_UNBREAKABLE = (1 << 21),
	SHOP_FLAG_DYNAMIC_ROBBERY_DISABLED = (1 << 22),
	SHOP_FLAG_FULLY_CLOSED = (1 << 23),
	SHOP_FLAG_KEEPER_SCRIPTED_ANIMS = (1 << 24),
	SHOP_FLAG_STOP_DIALOGUE = (1 << 25),
	SHOP_FLAG_MUTE_DIALOGUE = (1 << 26),
	SHOP_FLAG_DONT_GREET = (1 << 27),
	SHOP_FLAG_IS_MARKED_FRIEDNLY = (1 << 28),
	SHOP_FLAG_SET_HUD_CONTEXT = (1 << 29),
	SHOP_FLAG_SURPRESS_FOR_MINI_EXCHANGE = (1 << 30),
	SHOP_FLAG_BLIP_STATE_TUTORIAL = (1 << 31),
};
...
{
	STF_NONE = 0,
	STF_SHOP_SCRIPT_REQUESTED = (1 << 1),
	STF_SHOP_REGISTERED = (1 << 2),
	STF_SHOP_BLIP_ACTIVE = (1 << 3),
	STF_SHOP_IN_CARAVAN = (1 << 4),
	STF_SHOP_PERSCHAR_SCHEDULE_PAUSED = (1 << 5),
	STF_SHOP_THREATENED = (1 << 6),
	STF_SHOP_TYPE_DISABLED = (1 << 7),
	STF_SHOP_IS_OPEN = (1 << 8),
	STF_SHOP_IS_ACTIVE = (1 << 9),
	STF_REFRESH_SELL_TAB = (1 << 10),
	STF_SHOP_KEEPER_MODEL_LOADED = (1 << 11),
	STF_SHOP_KEEPER_CREATED = (1 << 12),
	STF_SHOP_KEEPER_TASKED = (1 << 13),
	STF_SHOP_CREATED_SCENARIO = (1 << 14),
	STF_SHOP_SUPPRESS_ROBBERY_TUTORIALS = (1 << 15),
	STF_REQUIRE_EXIT_TO_RESET = (1 << 16),
	STF_SHOP_TYPE_CONTEXTS_REQUESTED = (1 << 17),
	STF_SHOP_TYPE_CREATED_REL_GROUP = (1 << 18),
	STF_SHOP_TYPE_BROKEN_INTO = (1 << 19),
	STF_SHOP_PROP_MODEL_LOADED = (1 << 20),
	STF_SHOP_PROP_CREATED = (1 << 21),
	STF_SHOP_KEEPER_DISABLE_TASKING = (1 << 22),
	STF_SHOP_CONTEXTS_BEING_USED = (1 << 23),
	STF_SHOP_DISABLE_FORCE_WEAPON_HOLSTER = (1 << 24),
	STF_SHOP_PURCHASING_DISABLED = (1 << 25),
	STF_SHOP_KEEPER_ILO_REGISTERED = (1 << 26),
	STF_SHOP_KEEPER_CREATION_DELAYED = (1 << 27),
	STF_SHOP_FORCED_ILO_IS_ON = (1 << 28),
	STF_SHOP_MADE_PURCHASE = (1 << 29),
	STF_SHOP_TUTORIAL_COMPLETED = (1 << 30),
	STF_SHOP_KEEPER_BEEN_KILLED = (1 << 31),
};
